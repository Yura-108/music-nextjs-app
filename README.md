...
Живое демо: https://musicbrainz-explorer.vercel.app (если уже задеплоил)  
или просто запусти локально — за 30 секунд.
...
```bash
git clone https://github.com/твой-ник/musicbrainz-explorer.git
